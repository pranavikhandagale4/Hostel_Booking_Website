				...
				<form action="application_form.php?id=<?php echo $_GET['id']?>" method="POST">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="roll_no" placeholder="Email Address" value="<?php echo $_SESSION['roll']?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
...
<div id="display-image">
	...
	?>
    <!-- <div class="gallery">
    <a target="_blank" href="hostelimage.jpg"> -->
...
$query = " select Hostel_id from hostel  where Hostel_name= '".$_GET['id']."'";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($result);
$hi=$row['Hostel_id'];
echo $hi;
$query = " select * from image where Hostel_id= ".$hi;
$result = mysqli_query($conn, $query);
		    $i = 0;
            $j = 1;
            while ($data = mysqli_fetch_assoc($result)) {
